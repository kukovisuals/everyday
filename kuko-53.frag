...
void mainImage(out vec4 O, in vec2 I)
{
    ...
    if(dt < 20.0)
    {
        ...
        float lightFx = sin(u_time * 0.5) * -20.5 - 0.5;
            float lightFx2 = 1.2 * sin(u_time * 0.5) * -0.5 - 0.5;
            ...
            color += vec3(1.0, 0.8, 0.4) * rim * 3.0 * (1.0 + sin(u_time * 4.0) * 0.5);
